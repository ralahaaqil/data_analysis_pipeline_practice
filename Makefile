...
report/count_report.html: report/count_report.qmd results/isles.dat results/abyss.dat results/last.dat results/sierra.dat results/figure/isles.png results/figure/abyss.png results/figure/last.png results/figure/sierra.png
